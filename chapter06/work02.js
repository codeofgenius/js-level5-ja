...
以下のプログラムでは、オブジェクトtriangleの
メソッドgetAreaを変数getAnswerに代入しています。

この状態のままgetAnswer()を呼び出しても、thisが
不明なため正しく表示されません。

変数getAnswerに対してapplyメソッドを使用して呼び出して
ください。その際、第1引数にオブジェクトtriangleを指定し、
関数内部のthisがtriangleを指すようにしてください。
